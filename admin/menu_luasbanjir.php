            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabel Luas Banjir</h4>
                                <p class="category">Data Luas Banjir Kota Padang</p>
                          	</div>
                            </div>
                            <!---- Buat sebuah div dengan id="view" yang digunakan untuk menampung data yang ada pada tabel siswa di database-->
                            <div id="view"><?php include "tabel_luasbanjir.php"; ?></div>
							<a href="/webgisbanjir/admin/input_luasbanjir.php"><p>Input Data Luas Banjir</p></a>
                    </div>
                </div>
            </div>
        </div>
