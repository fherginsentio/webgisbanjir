            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabel Kapasitas Banjir</h4>
                                <p class="category">Data Kapasitas Banjir Kota Padang</p>
                          	</div>
                            </div>
                            <!---- Buat sebuah div dengan id="view" yang digunakan untuk menampung data yang ada pada tabel siswa di database-->
                            <div id="view"><?php include "tabel_kapasitas.php"; ?></div>
							<a href="/webgisbanjir/admin/input_kapasitas.php"><p>Input Data Kapasitas Banjir</p></a>
                    </div>
                </div>
            </div>
        </div>
