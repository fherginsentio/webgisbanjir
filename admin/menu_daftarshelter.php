...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <class="simple-text">
                    <img src="logopage.png" width="220px" height="150px">
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabel Daftar Shelter</h4>
                                <p class="category">Daftar Seluruh Shelter yang terdaftar di BPBD Kota Padang</p>
                          	</div>
                            </div>
                            <!---- Buat sebuah div dengan id="view" yang digunakan untuk menampung data yang ada pada tabel siswa di database-->
                            <div id="view"><?php include "tabel_daftarshelter.php"; ?></div>
                        </div>
                    </div>
                </div>
            </div>
