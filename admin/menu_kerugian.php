            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabel Kerugian Dan Kerusakan</h4>
                                <p class="category">Data Kerugian Dan Kerusakan</p>
                          	</div>
                            </div>
                            <!---- Buat sebuah div dengan id="view" yang digunakan untuk menampung data yang ada pada tabel siswa di database-->
                            <div id="view"><?php include "tabel_kerugian.php"; ?></div>
							<a href="/webgisbanjir/admin/input_kerugian.php"><p>Input Data Kerugian dan Kerusakan</p></a>
                    </div>
                </div>
            </div>
        </div>
