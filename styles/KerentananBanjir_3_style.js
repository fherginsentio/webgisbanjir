...
var style_KerentananBanjir_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("INDEKS KERENTANAN");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.666000 && value <= 0.732667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.732667 && value <= 0.799333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.799333 && value <= 0.866000) {
            style = [ new ol.style.Style({
