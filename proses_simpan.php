...
if ($lihatid>0)
{ $noid=((int) substr($idmax['max'],1,2))+1;
		$noidbaru='eT-'.sprintf( $noid);
	}
else{
		$noidbaru='ST-'.'001'; }
...
/*		
$eksekusi = mysql_query("INSERT INTO daftarshelter VALUES('$noidbaru','$namashelter','$alamatshelter','$fungsi','$latitude','$longitude','$jumlahlantai','$dayatampung')");
if(!$eksekusi){
?>
<script>alert('Terjadi kesalahan sistem saat input data!');document.location.href="inp-pendaftaranbaru.php";
</script>
<?php }else{ ?>
<script>alert('Data Berhasil Disimpan');document.location.href="tb-pendaftaran.php"
</script>
<?php } ?>
*/
?>